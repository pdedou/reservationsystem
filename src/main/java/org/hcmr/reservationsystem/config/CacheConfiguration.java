package org.hcmr.reservationsystem.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(org.hcmr.reservationsystem.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.hcmr.reservationsystem.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
